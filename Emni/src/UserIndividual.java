...
public class UserIndividual extends JFrame {
	...
	private void initComponents() {
		...
		jTextField13.setFont(new Font("Tahoma", 1, 12)); 
		jTextField14.setFont(new Font("Tahoma", 1, 12)); 
		jLabel16.setFont(new Font("Tahoma", 1, 14)); 
		...
		lbl_img1.setFont(new Font("Tahoma", 1, 18)); 
		lbl_img1.setForeground(new Color(51, 51, 255));
		lbl_img1.setText("Display Image");
		jLabel19.setFont(new Font("Tahoma", 1, 14)); 
...
*/
	...
	public void jButton2ActionPerformed(ActionEvent evt)
	{
		...
		try  
		{
			 Connection connection =  DriverManager.getConnection("jdbc:mysql://localhost/school",
                     "root", "123456");
