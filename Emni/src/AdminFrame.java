...
public class AdminFrame extends JFrame {
	...
	public AdminFrame() {
		...
		JLabel label = new JLabel("Academician details:");
						...
						|| t20.getText().equals("") || t21.getText().equals(""))
				{
					...
					try {
						...
						PreparedStatement ps = conn.prepareStatement(
								"INSERT INTO infoTable(form_id,batch_no,first_name,middle_name,"
					...
					} catch (SQLException se) 
					{
						...
						JOptionPane.showMessageDialog(null, "dekhao");
